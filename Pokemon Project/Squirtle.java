...
/**
 *
 * Class for the Squirtle object, with its attributes.
 *
 * @author Varune Tomar
 */
public class Squirtle extends Pokemon implements Water{
    ...
    /**
     * Returns special menu for Squirtle's type Water.
     */
    ...
    /**
     * Returns special items for Squirtle type Water, int 3.
     */
    ...
    /**
     * Takes attack input for Squirtle, and returns the move.
     *@param p
     *@param move
    ...
    public String watergun (Pokemon p){
        ...
        p.takeDamage(damage);
        wg = p.getName() + " is splashed by a watergun and takes " + damage + " damage" + "\n";
